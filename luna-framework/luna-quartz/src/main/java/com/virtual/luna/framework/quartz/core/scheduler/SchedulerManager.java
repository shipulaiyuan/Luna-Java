package com.virtual.luna.framework.quartz.core.scheduler;

import com.virtual.luna.common.base.utils.SnowUtil;
import com.virtual.luna.framework.quartz.core.enums.JobDataKeyEnum;
import com.virtual.luna.framework.quartz.core.handler.JobHandlerInvoker;
import com.virtual.luna.framework.quartz.exception.QuartzException;
import org.quartz.*;
...
public class SchedulerManager {
    ...
    public void addJob(Long jobId, String jobHandlerName, String jobHandlerParam, String cronExpression,
        ...
        JobDetail jobDetail = JobBuilder.newJob(JobHandlerInvoker.class)
                ...
                // 为了使多个定时任务通用一个Task
                .withIdentity(jobHandlerName + "_" + SnowUtil.nextId()).build();
        // 创建 Trigger 对象
    ...
    private Trigger buildTrigger(String jobHandlerName, String jobHandlerParam, String cronExpression,
        ...
        return TriggerBuilder.newTrigger()
                // 为了使多个定时任务通用一个Task
                .withIdentity(jobHandlerName + "_" + SnowUtil.nextId())
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw new QuartzException("[定时任务 - 已禁用]");
        }
    }
